...
*/
    ...
    GPIO_LED_Init.Mode=GPIO_MODE_INPUT;
    GPIO_LED_Init.Speed=GPIO_SPEED_FREQ_HIGH;
    GPIO_LED_Init.Pull=GPIO_NOPULL;

    HAL_GPIO_Init(GPIOD,&GPIO_LED_Init);
...
/*
    ...
    HAL_GPIO_Init(GPIOE,&GPIO_LED_Init);
*/
}
